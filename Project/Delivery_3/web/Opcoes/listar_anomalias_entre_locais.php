...
try {
    ...
    echo("<h2>Coordenadas Local_Publico</h2>");
    ...
    echo("<tr>");
    echo("<td>X</td>");
    echo("<form action='executar_listar_anomalias_entre_locais.php' method='post'>");
    foreach ($keys as $key) {
        echo("<td><input type='text' name='X$key'></td>");
    }
    echo("<td></td>");
    echo("</tr>");
    echo("<tr>");
    echo("<td>Y</td>");
    foreach ($keys as $key) {
        echo("<td><input type='text' name='Y$key'></td>");
    }
